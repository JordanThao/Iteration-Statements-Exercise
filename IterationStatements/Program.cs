namespace IterationStatements
{
    public class Program
    {
        ...
        public static void AreNumbersEqual(int numbOne, int numbTwo)
        {
            if (numbOne == numbTwo)
            {
                Console.WriteLine($"{numbOne} and {numbTwo} are the same!");
            }
            else
            {
                Console.WriteLine($"{numbOne} and {numbTwo} are not the same!");
            }
        }
